			...
			<div class="_gaps_m znqjceqz">
				...
				<FormSection>
					...
					<div :class="$style.contributors">
						...
						<a href="https://github.com/k3vg3n" target="_blank" :class="$style.contributor">
							<img src="https://avatars.githubusercontent.com/u/87700221?s=96&v=4" :class="$style.contributorAvatar">
							<span :class="$style.contributorUsername">@k3vg3n</span>
						</a>
					</div>
				</FormSection>
				<FormSection>
